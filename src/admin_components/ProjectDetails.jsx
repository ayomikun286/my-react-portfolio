...
const ProjectDetails = ({ project, onClose }) => {
  ...
  return (
    <div className='absolute flex justify-center items-center bg-black/50 inset-0 w-full h-full top-0 left-0 p-4 z-50'>
      <div className="w-full max-w-5xl h-[80vh] bg-[#0B1422] rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-white/10">
          ...
          <button className="text-slate-400 hover:text-white text-2xl" onClick={() => onClose(false)}>
            ✕
          </button>
        </div>
