...
const ADnavbar = ({setIsOpen}) => {
    return (
        <div className='p-2.5 px-8 flex items-center justify-between  w-full border-b text-white  border-gray-500/30' >
            <div 
            onClick={()=> setIsOpen(true)}
            className=' rounded border-gray-500/50 gap-1 p-1.5 flex flex-col justify-center items-center'>
                <span className='w-6.5 h-0.5 bg-white'></span>
                <span className='w-6.5 h-0.5 bg-white'></span>
                <span className='w-6.5 h-0.5 bg-white'></span>
            </div>
                ...
                <div className='flex items-center  md:gap-10'>
                    ...
                    <FaSun className='hidden md:block' />
