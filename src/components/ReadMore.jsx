...
const ReadMore = ({ setReadMore, onOpenProject }) => {
    ...
    return (
        ...
        <div className='fixed top-0 left-0 inset-0 w-screen overflow-hidden h-screen flex justify-center items-center bg-black/50 backdrop-blur-[10px] z-80 p-4 md:p-10  '>
